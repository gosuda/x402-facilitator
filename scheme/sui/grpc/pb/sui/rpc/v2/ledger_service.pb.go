...
func (x *GetObjectResult) GetError() *rpc.Status {
	if x != nil {
...
type GetObjectResult_Error struct {
	Error *rpc.Status `protobuf:"bytes,2,opt,name=error,proto3,oneof"`
}
...
func (x *GetTransactionResult) GetError() *rpc.Status {
	if x != nil {
...
const file_sui_rpc_v2_ledger_service_proto_rawDesc = "" +
	...
	"\bGetEpoch\x12\x1b.sui.rpc.v2.GetEpochRequest\x1a\x1c.sui.rpc.v2.GetEpochResponseB\xb6\x01\n" +
	"\x0ecom.sui.rpc.v2B\x12LedgerServiceProtoP\x01ZFgithub.com/gosuda/x402-facilitator/scheme/sui/grpc/pb/sui/rpc/v2;rpcv2\xa2\x02\x03SRX\xaa\x02\n" +
	"Sui.Rpc.V2\xca\x02\n" +
...
var file_sui_rpc_v2_ledger_service_proto_goTypes = []any{
	...
	(*rpc.Status)(nil),                   // 19: google.rpc.Status
