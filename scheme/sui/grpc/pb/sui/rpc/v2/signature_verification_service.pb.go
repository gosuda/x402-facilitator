...
const file_sui_rpc_v2_signature_verification_service_proto_rawDesc = "" +
	...
	"\x0fVerifySignature\x12\".sui.rpc.v2.VerifySignatureRequest\x1a#.sui.rpc.v2.VerifySignatureResponseB\xc5\x01\n" +
	"\x0ecom.sui.rpc.v2B!SignatureVerificationServiceProtoP\x01ZFgithub.com/gosuda/x402-facilitator/scheme/sui/grpc/pb/sui/rpc/v2;rpcv2\xa2\x02\x03SRX\xaa\x02\n" +
	"Sui.Rpc.V2\xca\x02\n" +
