...
const file_sui_rpc_v2_protocol_config_proto_rawDesc = "" +
	...
	"\x11_protocol_versionB\xb7\x01\n" +
	"\x0ecom.sui.rpc.v2B\x13ProtocolConfigProtoP\x01ZFgithub.com/gosuda/x402-facilitator/scheme/sui/grpc/pb/sui/rpc/v2;rpcv2\xa2\x02\x03SRX\xaa\x02\n" +
	"Sui.Rpc.V2\xca\x02\n" +
